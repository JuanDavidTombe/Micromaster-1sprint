...
<div id="app" class="visible">
  ...
  <aside class="sidebar">
    ...
    <a class="nav-item active" href="simulador.php">
      ...
      <div class="page active" id="page-simulador">
        <div class="calc-grid">
          <div class="calc-panel">
            <h3><span class="section-icon">📈</span>Configuración</h3>
            ...
            <div class="field" style="margin-bottom:20px">
              <label>% Variación de precio de insumos</label>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;align-content:start">
            ...
            <div class="calc-panel" style="text-align:center">
              <div class="calc-label-sm">Variación %</div>
